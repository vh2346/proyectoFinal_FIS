			...
			<div class="col-lg-12">
				...
				<div class="card">
					<div class="card-header">
						<span><b>Control de asistencia</b></span>
						<button class="btn btn-primary btn-sm btn-block col-md-3 float-right" type="button" id="new_attendance_btn"><span class="fa fa-plus"></span> Añadir a la lista</button>
					</div>
					<div class="card-body">
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('.edit_attendance').click(function(){
				...
				uni_modal("Editar empleado","manage_attendance.php?id="+$id)
				
			});
			$('.view_attendance').click(function(){
				var $id=$(this).attr('data-id');
				uni_modal("Detalles de empleado","view_attendance.php?id="+$id,"mid-large")
				
			});
			$('#new_attendance_btn').click(function(){
				uni_modal("Nuevo tiempo","manage_attendance.php",'mid-large')
			})
