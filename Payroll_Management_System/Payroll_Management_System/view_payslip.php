...
<div class="contriner-fluid">
	<div class="col-md-12">
		...
		<div class="row">
			<div class="col-md-6">
				<p><b>Referencia nómina : <?php echo $pay['ref_no'] ?></b></p>
				<p><b>Fecha nómina : <?php echo date("M d, Y",strtotime($pay['date_from'])). " - ".date("M d, Y",strtotime($pay['date_to'])) ?></b></p>
				<p><b>Tipo de nómina : <?php echo $pt[$pay['type']] ?></b></p>
			</div>
			<div class="col-md-6">
				<p><b>Dias de ausencia : <?php echo $absent ?></b></p>
				<p><b>Tiempo de retardos (mins) : <?php echo $late ?></b></p>
				<p><b>Total Novedades : <?php echo number_format($allowance_amount,2) ?></b></p>
				...
				<div class="card">
					...
					<div class="card-body">
						<ul class="list-group">
						   ...
						   <?php echo $all_arr[$val->aid] ?> Novedades
