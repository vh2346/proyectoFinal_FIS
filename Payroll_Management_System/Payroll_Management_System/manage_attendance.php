...
<div class="container-fluid">
	...
	<form action="" id="employee-attendance">
		<div class="row form-group">
			<div class="col-md-4">
				<label for="" class="control-label">Empleados</label>
			...
			<div class="col-md-3">
				...
				<select id="type" class="borwser-default custom-select">
					<option value="1">Tiempo llegada am</option>
					<option value="2">Tiempo salida am</option>
					<option value="3">Tiempo llegada am</option>
					<option value="4">Tiempo salida pm</option>
				</select>
			</div>
			<div class="col-md-3">
			...
			<div class="col-md-2">
				...
				<button class="btn btn-primary btn-block btn-sm" type="button" id="add_list"> Añadir a la lista</button>
			</div>	
		</div>
